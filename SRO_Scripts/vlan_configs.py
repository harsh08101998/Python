...
def usage():
    ...
    print(f"")
    print(f"Examples:")
    print(f"  {sys.argv[0]} centos.pem root 080-33.exotel.in 22000 ens256 10:192.168.10.123:airtel.sip.com")
    print(f"  {sys.argv[0]} centos.pem asterisk 080-33.exotel.in 22000 ens256 10:192.168.10.123:airtel.sip.com")
    sys.exit(1)
...
def create_vlan_config_remote(ssh_client, parent_if, vlan_id, ipaddr, gateway_ip):
    ...
    # ONLY modify these 4 specific parameters
    vlan_config['DEVICE'] = vlan_if
