...
## Twilix connection 
conn=mysql.connector.connect(host='10.1.2.26', user='postern', password='spyonme', database='twilix 
...
hh=All_Connection_MUM.Twilix_Small_Table(query, 'csv','MUM_Twilix_closed_2022_new.csv 
print(hh)
hh=All_Connection_MUM.Twilix_Small_Table(query1, 'csv','MUM_Twilix_Live_2022.csv 
print(hh)
hh=All_Connection_MUM.Twilix_Small_Table(query2, 'csv','MUM_data_2022.csv 
print(hh)
hh=All_Connection_MUM.exe_mqchine(query3, 'csv','MUM_Live_date_2022.csv 
print(hh)
hh=All_Connection_MUM.Billix_Master_Table(query4, 'csv','MUM_Currency_2022.csv 
print(hh)
hh=All_Connection_MUM.Billix_Master_Table(query5, 'csv','MUM_Balance.csv 
print(hh)
hh=All_Connection_MUM.Billix_Master_Table(query7, 'csv','MUM_paid_2022.csv 
print(hh)
