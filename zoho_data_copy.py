...
query1="select accountSid, createdOn, status   from exotel_account where createdOn BETWEEN '2022-09-01 00:00:00' AND '2022-09-30 23:59:59'  order by createdOn asc"
Product_DB(query1, 'csv','Zoho_CRM_Tenants_Enabled.csv 

query2="select count(*) as Call_Count, callType  from exotel_call_log where createdOn BETWEEN '2022-09-01 00:00:00' AND '2022-09-30 23:59:59' group by callType"
...
print(tuple(zoho_crm_account_list))
revenue="select sum(Quantity), sum(Amount) as InvoiceAmount, AccountSid from AggregateUsage where AccountSid in {} and SkuId='call' and FromTime BETWEEN '2022-09-01 00:00:00' AND '2022-09-30 23:59:59'group by AccountSid".format(tuple(zoho_crm_account_list))
...
query1=" select sid, createdOn, status   from exotel_account where createdOn BETWEEN '2022-09-01 00:00:00' AND '2022-09-30 23:59:59' order by createdOn asc"
Product_DB_Desk(query1, 'csv','Zoho_Desk_Tenants_Enabled.csv 

query2="select count(*), callType  from exotel_call_log where createdOn BETWEEN '2022-09-01 00:00:00' AND '2022-09-30 23:59:59' group by callType ;"
...
print(tuple(zoho_desk_account_list))
revenue="select sum(Quantity), sum(Amount) as InvoiceAmount, AccountSid from AggregateUsage where AccountSid in {} and SkuId='call' and FromTime BETWEEN '2022-09-01 00:00:00' AND '2022-09-30 23:59:59' group by AccountSid".format(tuple(zoho_desk_account_list))
